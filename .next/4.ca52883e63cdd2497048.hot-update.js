                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 4:
                            ...
                            for (_iterator = promises[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                              _promise = _step.value;

                              try {
                                _this4.setState({
                                  astros: _toConsumableArray(_this4.state.astros)
                                });
                              } catch (error) {
...
//# sourceMappingURL=4.ca52883e63cdd2497048.hot-update.js.map